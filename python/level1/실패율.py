...
# 풀이유추
# stages를 sort하여 순서대로 정렬한후
# 스테이지에 해당하는 원소의 갯수/원소부터 배열끝까지의 길이를 return하면 되는문제
# dict로 스테이지를 기억하고 낮은순서대로 sort하여 result에 return
# count()사용

# 변수선언
# input : N, stages :: int, list
# FPD (Failure percent dictation) : dict
# ouput : result :: list
