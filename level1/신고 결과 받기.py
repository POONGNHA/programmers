...
# 풀이 유추
# report의 원소를 split으로 나눈 다음 set안에 담는다.
# 중복이 제거되었으니 report 안에 idx = 1인 이름을 담은 list를 만든다.
# 그 리스트 원소를 id_list로 count()해서 k보다 크다면 set_report에서 idx=0인 원소의 갯수를 return한다.

# 변수 선언
# input : id_list, report, k :: list, list, int
# report_set : set
# reported_list : list
# reporter_list : list
# output : result :: list
