...
# 풀이 유추
# score의 길이를 score보다 크지 않은 m의 최대배수까지 자른다
# sort를 사용한다
# 제일 높은 점수의 사과부터 상자에 m개 집어넣고,
# 그 박스에 들어간 사과의 최소값 * m을 해서 박스 하나의 가격을 구한다.

# 변수선언
# input : k, m, score : int int list
# tempList : 2 Dimentional list 
# output : result : int
